...
import { getSingleOrder, getSingleReturnOrder, newOrderAction, orderDelivered, pickedupOrder } from '../../../redux/store/orderReducer'
...
import { FormControl, InputGroup } from 'react-bootstrap'
    ...
    const singleReturnedOrder = useSelector((state) => state.order?.single_returned_order?.data?.order_item);
    ...
    useEffect(() => {
        if (localStorage.getItem("userLogin") && localStorage.getItem("auth_token")) {
            ...
            dispatch(getSingleReturnOrder(formData)).then((response) => {
      ...
      return (
        ...
        <div className='px-3 w-100'>
            <div className='bg-white py-3 rounded-xl mt-3' style={{ boxShadow: "0px 0px 20px #99999938" }}>
                <div style={{ color: "#070648", fontWeight: "700" }} className='px-3'>#{singleReturnedOrder?.order?.unique_order_id}</div>
                <hr style={{ color: "#a1a1a1" }} />
                <div className='leading-loose text-muted px-3'>
                    <div className='flex justify-between'>
                        <div className='font-medium'>Customer</div>
                        <div className='font-bold'>{singleReturnedOrder?.order?.user_name}</div>
                    </div>
                    <div className='flex justify-between'>
                        <div className='font-medium'>Customer number</div>
                        <div className='font-bold '>{singleReturnedOrder?.order?.user?.phone}</div>
                    </div>
                    <div className='flex justify-between'>
                        <div className='font-medium'>Address</div>
                        <div className='w-75 font-bold text-end'>{singleReturnedOrder?.order?.address}</div>
                    </div>
                </div>
                ...
                <div className='flex gap-3 px-3'>
                    ...
                    {singleReturnedOrder?.order?.user?.phone ?
                        <a href={`tel:${singleReturnedOrder?.order?.user?.phone}`} className='order-accept-button text-center mt-3 flex items-center justify-center no-underline' >
        ...
        <div className='px-3 w-100  pt-3' >
            <div className='bg-white py-3 rounded-xl ' style={{ boxShadow: "0px 0px 20px #99999938" }}>
                <div style={{ color: "#070648", fontWeight: "700" }} className='px-3'>Warehouse details</div>
                <hr style={{ color: "#a1a1a1" }} />
                <div className='leading-loose text-muted px-3'>
                    <div className='flex justify-between'>
                        <div className='font-medium'>Warehouse</div>
                        <div className='font-bold'>{singleReturnedOrder?.order?.warehouse?.phone}</div>
                    </div>
                    <div className='flex justify-between'>
                        <div className='font-medium'>address</div>
                        <div className='w-75 font-bold text-end'>{singleReturnedOrder?.order?.warehouse?.address}</div>
                    </div>
                    {/* <div className='flex justify-between'>
                ...
                <div className='flex gap-3 px-3'>
                    ...
                    {singleReturnedOrder?.order?.warehouse?.phone ?
                        <a href={`tel:${singleReturnedOrder?.order?.warehouse?.phone}`} className='call-button text-center mt-3 flex items-center justify-center no-underline' >
                            <CiMobile2 color='#fff' size={24} />  <span className='ms-1'>Call</span>
                        </a>
                        :
            ...
            <div className='bg-white py-3 rounded-xl ' style={{ boxShadow: "0px 0px 20px #99999938" }}>
                ...
                <div className='leading-loose text-muted px-3 tracking-tighter'>
                    ...
                    <div className='flex justify-between'>
                        ...
                        <div className='font-bold'>Rs {parseFloat(singleReturnedOrder?.price).toFixed(2)}</div>
                    </div>
                </div>
            </div>
        </div>
